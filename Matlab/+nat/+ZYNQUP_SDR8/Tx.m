...
% Module      : Tx.m
%
% Description : Tx Class for the NAT-AMC-ZYNQUP-SDR8
%
...
classdef Tx < nat.ZYNQUP_SDR8.Base & adi.common.Tx
    % nat.ZYNQUP_SDR8.Tx Transmit data from the ZYNQUP SDR8 transceiver
    %   The nat.ZYNQUP_SDR8.Tx System object is a signal sink that can tranmsit
    %   complex data from the ZYNQUP SDR8.
    %
    %   tx = nat.ZYNQUP_SDR8.Tx;
    %   tx = nat.ZYNQUP_SDR8.Tx('uri','192.168.2.1');
    %
    ...
    properties
        ...
        AttenuationChannel4 = -30;
        AttenuationChannel5 = -30;
        AttenuationChannel6 = -30;
        AttenuationChannel7 = -30;
    end
    ...
    properties (Logical)
        ...
        EnableLOLeakageTrackingChannel4 = true;
        EnableLOLeakageTrackingChannel5 = true;
        EnableLOLeakageTrackingChannel6 = true;
        EnableLOLeakageTrackingChannel7 = true;
    end
    ...
    properties(Logical, Nontunable)
        ...
        EnableLOLeakageCorrectionPhyC = true;
        EnableLOLeakageCorrectionPhyD = true;
        ...
        EnableLOLeakageCorrectionExternalPhyC = false;
        EnableLOLeakageCorrectionExternalPhyD = false;
    end
    ...
    methods
        ...
        function set.AttenuationChannel4(obj, value)
            validateattributes( value, { 'double','single' }, ...
                { 'real', 'scalar', 'finite', 'nonnan', 'nonempty', '>=', -41.95,'<=', 0}, ...
                '', 'Attenuation');
            assert(mod(value,1/20)==0, 'Attentuation must be a multiple of 0.05');
            obj.AttenuationChannel4 = value;
            if obj.ConnectedToDevice
                obj.setAttributeLongLong('voltage0','hardwaregain',value,true,'adrv9009-phy-c');
            end
        end
        function set.AttenuationChannel5(obj, value)
            validateattributes( value, { 'double','single' }, ...
                { 'real', 'scalar', 'finite', 'nonnan', 'nonempty', '>=', -41.95,'<=', 0}, ...
                '', 'Attenuation');
            assert(mod(value,1/20)==0, 'Attentuation must be a multiple of 0.05');
            obj.AttenuationChannel5 = value;
            if obj.ConnectedToDevice
                obj.setAttributeLongLong('voltage1','hardwaregain',value,true,'adrv9009-phy-c');
            end
        end
        function set.AttenuationChannel6(obj, value)
            validateattributes( value, { 'double','single' }, ...
                { 'real', 'scalar', 'finite', 'nonnan', 'nonempty', '>=', -41.95,'<=', 0}, ...
                '', 'Attenuation');
            assert(mod(value,1/20)==0, 'Attentuation must be a multiple of 0.05');
            obj.AttenuationChannel6 = value;
            if obj.ConnectedToDevice
                obj.setAttributeLongLong('voltage0','hardwaregain',value,true,'adrv9009-phy-d');
            end
        end
        function set.AttenuationChannel7(obj, value)
            validateattributes( value, { 'double','single' }, ...
                { 'real', 'scalar', 'finite', 'nonnan', 'nonempty', '>=', -41.95,'<=', 0}, ...
                '', 'Attenuation');
            assert(mod(value,1/20)==0, 'Attentuation must be a multiple of 0.05');
            obj.AttenuationChannel7 = value;
            if obj.ConnectedToDevice
                obj.setAttributeLongLong('voltage1','hardwaregain',value,true,'adrv9009-phy-d');
            end
        end
        ...
        function set.PowerdownChannel4(obj, value)
            ...
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','powerdown',value,true,'adrv9009-phy-c');
            end
        end
        function set.PowerdownChannel5(obj, value)
            obj.PowerdownChannel5 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','powerdown',value,true,'adrv9009-phy-c');
            end
        end
        function set.PowerdownChannel6(obj, value)
            obj.PowerdownChannel6 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','powerdown',value,true,'adrv9009-phy-d');
            end
        end
        function set.PowerdownChannel7(obj, value)
            obj.PowerdownChannel7 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','powerdown',value,true,'adrv9009-phy-d');
            end
        end
        ...
        function set.EnableQuadratureTrackingChannel4(obj, value)
            ...
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','quadrature_tracking_en',value,true,'adrv9009-phy-c');
            end
        end
        function set.EnableQuadratureTrackingChannel5(obj, value)
            obj.EnableQuadratureTrackingChannel5 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','quadrature_tracking_en',value,true,'adrv9009-phy-c');
            end
        end
        function set.EnableQuadratureTrackingChannel6(obj, value)
            obj.EnableQuadratureTrackingChannel6 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','quadrature_tracking_en',value,true,'adrv9009-phy-d');
            end
        end
        function set.EnableQuadratureTrackingChannel7(obj, value)
            obj.EnableQuadratureTrackingChannel7 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','quadrature_tracking_en',value,true,'adrv9009-phy-d');
            end
        end
        ...
        function set.EnableLOLeakageTrackingChannel4(obj, value)
            obj.EnableLOLeakageTrackingChannel4 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','lo_leakage_tracking_en',value,true,'adrv9009-phy-c');
            end
        end
        function set.EnableLOLeakageTrackingChannel5(obj, value)
            obj.EnableLOLeakageTrackingChannel5 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','lo_leakage_tracking_en',value,true,'adrv9009-phy-c');
            end
        end
        function set.EnableLOLeakageTrackingChannel6(obj, value)
            obj.EnableLOLeakageTrackingChannel6 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage0','lo_leakage_tracking_en',value,true,'adrv9009-phy-d');
            end
        end
        function set.EnableLOLeakageTrackingChannel7(obj, value)
            obj.EnableLOLeakageTrackingChannel7 = value;
            if obj.ConnectedToDevice
                obj.setAttributeBool('voltage1','lo_leakage_tracking_en',value,true,'adrv9009-phy-d');
            end
        end
    end
    ...
    methods (Hidden, Access = protected)
        ...
        function setupInit(obj)
            ...
            obj.setAttributeLongLong('altvoltage0','frequency',obj.CenterFrequencyPhyD ,true,'adrv9009-phy-d');
            ...
            obj.setAttributeLongLong('voltage0','hardwaregain',obj.AttenuationChannel4,true,'adrv9009-phy-c');
            obj.setAttributeLongLong('voltage1','hardwaregain',obj.AttenuationChannel5,true,'adrv9009-phy-c');
            obj.setAttributeLongLong('voltage0','hardwaregain',obj.AttenuationChannel6,true,'adrv9009-phy-d');
            obj.setAttributeLongLong('voltage1','hardwaregain',obj.AttenuationChannel7,true,'adrv9009-phy-d');
            ...
            obj.setAttributeBool('voltage0','quadrature_tracking_en',obj.EnableQuadratureTrackingChannel4,true,'adrv9009-phy-c');
            obj.setAttributeBool('voltage1','quadrature_tracking_en',obj.EnableQuadratureTrackingChannel5,true,'adrv9009-phy-c');
            obj.setAttributeBool('voltage0','lo_leakage_tracking_en',obj.EnableLOLeakageTrackingChannel4,true,'adrv9009-phy-c');
            obj.setAttributeBool('voltage1','lo_leakage_tracking_en',obj.EnableLOLeakageTrackingChannel5,true,'adrv9009-phy-c');
            obj.setAttributeBool('voltage0','quadrature_tracking_en',obj.EnableQuadratureTrackingChannel6,true,'adrv9009-phy-d');
            obj.setAttributeBool('voltage1','quadrature_tracking_en',obj.EnableQuadratureTrackingChannel7,true,'adrv9009-phy-d');
            obj.setAttributeBool('voltage0','lo_leakage_tracking_en',obj.EnableLOLeakageTrackingChannel6,true,'adrv9009-phy-d');
            obj.setAttributeBool('voltage1','lo_leakage_tracking_en',obj.EnableLOLeakageTrackingChannel7,true,'adrv9009-phy-d');
            ...
            obj.setDeviceAttributeRAW('calibrate_tx_qec_en',num2str(obj.EnableQuadratureCalibrationPhyC),'adrv9009-phy-c');
            obj.setDeviceAttributeRAW('calibrate_tx_lol_en',num2str(obj.EnableLOLeakageCorrectionPhyC),'adrv9009-phy-c');
            obj.setDeviceAttributeRAW('calibrate_tx_lol_ext_en',num2str(obj.EnableLOLeakageCorrectionExternalPhyC),'adrv9009-phy-c');
            obj.setDeviceAttributeRAW('calibrate',num2str(true),'adrv9009-phy-c');
            obj.setDeviceAttributeRAW('calibrate_tx_qec_en',num2str(obj.EnableQuadratureCalibrationPhyD),'adrv9009-phy-d');
            obj.setDeviceAttributeRAW('calibrate_tx_lol_en',num2str(obj.EnableLOLeakageCorrectionPhyD),'adrv9009-phy-d');
            obj.setDeviceAttributeRAW('calibrate_tx_lol_ext_en',num2str(obj.EnableLOLeakageCorrectionExternalPhyD),'adrv9009-phy-d');
